...
/**
 * 1668928 -- merge 704982704 -- bubble 704882705 -- insertion 1409865409 -- selection
 * 
 * @author gkushwaha
 *
 */
public class QuickSortPivotEnd {
    ...
    private static int partition(final int[] input, int start, final int end) {
