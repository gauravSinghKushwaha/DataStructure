...
public class TestUnsafeAndRefelction {
	...
	InvocationTargetException, NoSuchMethodException, SecurityException {
		...
		final Constructor<?>[] constructors = TestUnsafeAndRefelction.class
				.getDeclaredConstructors();
		final TestUnsafeAndRefelction obj = (TestUnsafeAndRefelction) constructors[0]
				.newInstance();
		obj.method();
		...
		final TestUnsafeAndRefelction instance = (TestUnsafeAndRefelction) unsafe
				.allocateInstance(TestUnsafeAndRefelction.class);
		assertEquals(0, instance.value);

		// Using reflection factory , without calling some other class
		// constructor constructor (borrowing)
		final Constructor<TestUnsafeAndRefelction> silentConstructor = (Constructor<TestUnsafeAndRefelction>) ReflectionFactory
				.getReflectionFactory().newConstructorForSerialization(
						TestUnsafeAndRefelction.class,
		...
		// Using reflection factory , without calling some other class
		// constructor constructor (borrowing)
		final Constructor<TestUnsafeAndRefelction> silentConstructor2 = (Constructor<TestUnsafeAndRefelction>) ReflectionFactory
				.getReflectionFactory().newConstructorForSerialization(
						TestUnsafeAndRefelction.class,
		...
		final Constructor<TestUnsafeAndRefelction> nonSilentConstructor = (Constructor<TestUnsafeAndRefelction>) ReflectionFactory
				.getReflectionFactory().newConstructorForSerialization(
						TestUnsafeAndRefelction.class,
		...
		final DirectIntArray directIntArray = new DirectIntArray(unsafe,
				maximum);
